...
const stories: Story[] = [
  {
    ...
    story: 'Llevaba 3 años con ansiedad generalizada. Probé terapia, medicación, yoga... nada me hacía click. Con Berzosa Neuro entendí que mi problema no era solo emocional: era no saber parar la cabeza. Mi mente inventaba escenarios porque nadie me había enseñado a bajar el volumen. En 12 semanas de Curso 21 Días + meditaciones diarias, mi NeuroScore pasó de 18 a 72. No es magia: es constancia con método.',
  ...
  },
  {
    ...
    story: 'Mis hijos me decían "papá, no me escuchas". Tenían razón. Estaba presente físicamente pero mi mente siempre estaba en otro sitio. Los ejercicios de observar la mente y el diario de presencia me hicieron ver que vivía el 90% del tiempo en piloto automático. Ahora mis hijos dicen que soy otro papá.',
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="pt-8 md:pt-16 pb-4">
        <Container>
          <h1 className="font-heading text-3xl font-bold text-white mb-1 animate-fade-in">Historias reales</h1>
          <p className="text-text-secondary text-sm animate-fade-in-up">Casos con NeuroScore antes y después. Sin inventar números.</p>
        </Container>
      </section>
