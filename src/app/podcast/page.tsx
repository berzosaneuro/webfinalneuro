...
const episodes: Episode[] = [
  ...
  { id: 11, title: 'Estrés crónico: cuando la alarma no se apaga', description: 'Tu cuerpo vive en modo emergencia aunque no haya ninguna emergencia. El cortisol crónico deteriora la memoria y envejece el cerebro.', duration: '5:50', date: '2025-02-16', category: 'Neurociencia',
    script: 'NeuroPodcast. Estrés crónico: cuando la alarma no se apaga. Tu cuerpo vive en modo emergencia aunque no haya ninguna emergencia. El cortisol es útil en dosis agudas: te da energía para enfrentar el peligro. El problema es el estrés crónico. Años de cortisol elevado reducen el hipocampo, la región del cerebro clave para la memoria. Deterioran la corteza prefrontal, la sede del juicio y la toma de decisiones. Y aceleran el envejecimiento celular. El primer paso para salir: distinguir entre urgencia real y urgencia fabricada por el pensamiento.' },
  { id: 12, title: 'Qué pasa en tu cerebro cuando meditas', description: 'Las imágenes de resonancia magnética lo confirman: meditar 20 minutos al día cambia físicamente tu cerebro en semanas.', duration: '6:10', date: '2025-02-23', category: 'Neurociencia',
    script: 'NeuroPodcast. Qué pasa en tu cerebro cuando meditas. Las imágenes de resonancia magnética lo confirman: meditar veinte minutos al día cambia físicamente tu cerebro en semanas. La amígdala se reduce. La corteza prefrontal se engrosa. Las conexiones entre el córtex cingulado y las redes de regulación emocional se fortalecen. No es metáfora. Es anatomía. El cerebro que medita procesa el dolor emocional diferente al que no medita. No lo suprime. Lo observa. Y esa diferencia lo cambia todo.' },
  { id: 13, title: 'La emoción no es tuya, es información', description: 'Las emociones duran 90 segundos si no las alimentas con pensamiento. Lo demás es una elección.', duration: '5:00', date: '2025-03-02', category: 'Emociones',
    script: 'NeuroPodcast. La emoción no es tuya, es información. La neurocientífica Jill Bolte Taylor descubrió que una emoción dura noventa segundos si no la alimentas. El ciclo fisiológico se activa, llega a su pico y se disuelve. Lo que dura más no es la emoción. Es el pensamiento que la mantiene viva. Cuando tienes miedo y sigues pensando en el peligro, produces más cortisol, que produce más miedo. Las emociones son mensajeras. Escúchalas, no te cases con ellas.' },
  { id: 14, title: 'El mito de la fuerza de voluntad', description: 'La fuerza de voluntad es un recurso limitado que se agota. No te funciona porque nadie te explicó cómo funciona realmente.', duration: '5:35', date: '2025-03-09', category: 'Consciencia',
    script: 'NeuroPodcast. El mito de la fuerza de voluntad. La fuerza de voluntad es un recurso limitado que se agota. Los estudios de Roy Baumeister lo demuestran: después de tomar muchas decisiones, la calidad de las siguientes empeora. Se llama fatiga de decisión. Por eso los grandes cambios no dependen de la fuerza de voluntad. Dependen del diseño del entorno. Si tienes que resistirte a algo cada día, perderás. Si rediseñas tu entorno para que la opción fácil sea la correcta, ganas sin esfuerzo.' },
  { id: 15, title: 'Sueño: el mantenimiento que ignoras', description: 'Durante el sueño tu cerebro se limpia literalmente. Sin ese proceso, acumulas residuos que dañan las neuronas.', duration: '6:20', date: '2025-03-16', category: 'Cuerpo',
    script: 'NeuroPodcast. Sueño: el mantenimiento que ignoras. Durante el sueño profundo, el sistema glinfático activa un proceso de limpieza cerebral. Las células gliales se contraen, el espacio entre neuronas aumenta, y el líquido cefalorraquídeo arrastra los residuos metabólicos acumulados. Entre ellos, proteínas relacionadas con el Alzheimer. No dormir bien no es solo cansancio. Es acumulación de daño neurológico. Siete u ocho horas no son un lujo. Son el tiempo mínimo que tu cerebro necesita para repararse.' },
  { id: 16, title: 'Ansiedad social: el cerebro tribal', description: 'Tu cerebro está diseñado para evitar la exclusión del grupo. Por eso el rechazo social duele igual que el daño físico.', duration: '5:15', date: '2025-03-23', category: 'Emociones',
    script: 'NeuroPodcast. Ansiedad social: el cerebro tribal. Para tu cerebro, ser excluido del grupo social equivale a morir. Durante miles de años, la exclusión era la muerte real: sin tribu no había comida ni protección. Por eso el rechazo social activa las mismas regiones que el dolor físico. La ansiedad social no es una debilidad. Es un sistema de alerta sobredimensionado para el mundo actual. Conocerlo no lo elimina, pero te permite observarlo sin identificarte como si fueras el problema.' },
  { id: 17, title: 'Cómo el habla interna te construye o te destruye', description: 'El diálogo interno corre a 800 palabras por minuto. La mayoría son críticas. Tu cerebro lo procesa casi igual que si viniera de otra persona.', duration: '5:40', date: '2025-03-30', category: 'Consciencia',
    script: 'NeuroPodcast. Cómo el habla interna te construye o te destruye. El diálogo interno corre a ochocientas palabras por minuto. La mayoría son críticas. Y tu cerebro procesa esas palabras casi igual que si viniera de otra persona. La autocrítica activa las mismas regiones que el dolor social. Cuando te dices que eres un fracasado, tu sistema nervioso reacciona. El cambio empieza por cambiar el tono, no el contenido. Habla contigo como lo harías con alguien a quien quieres.' },
  { id: 18, title: 'Gratitud: por qué funciona y no es positivismo tóxico', description: 'La gratitud cambia la química cerebral en segundos. Pero hay una forma que funciona y formas que no.', duration: '4:55', date: '2025-04-06', category: 'Presencia',
    script: 'NeuroPodcast. Gratitud: por qué funciona y no es positivismo tóxico. La gratitud genuina activa el córtex prefrontal y libera dopamina y serotonina. Pero hay una diferencia clave entre la gratitud real y el positivismo tóxico. La gratitud real reconoce también el dolor. No lo niega. Dice: esto es difícil, Y también hay esto otro que valoro. El positivismo tóxico dice: todo pasa por algo, sé positivo. Ignora el dolor. La gratitud no es optimismo forzado. Es honestidad completa.' },
  { id: 19, title: 'Tus creencias cambian tu biología', description: 'El efecto placebo no es "solo imaginación". Es neurobiología pura. Lo que crees modifica literalmente lo que ocurre en tu cuerpo.', duration: '6:05', date: '2025-04-13', category: 'Neurociencia',
    script: 'NeuroPodcast. Tus creencias cambian tu biología. El efecto placebo no es solo imaginación. Es neurobiología pura. Cuando crees que un tratamiento funciona, tu cerebro libera las mismas sustancias que liberaría el tratamiento real. Opioides endógenos, dopamina, serotonina. Ellen Langer demostró que cambiar las creencias de un grupo de personas sobre el envejecimiento mejoró su visión, audición y fuerza muscular en una semana. No cambiaron nada externo. Cambiaron lo que esperaban. Y el cuerpo siguió.' },
  { id: 20, title: 'El aburrimiento como superpoder', description: 'Tu cerebro necesita el aburrimiento para integrar experiencias, ser creativo y regularse. Le estás robando ese tiempo.', duration: '4:45', date: '2025-04-20', category: 'Presencia',
    script: 'NeuroPodcast. El aburrimiento como superpoder. El aburrimiento activa la Red Neuronal por Defecto: el estado de reposo activo del cerebro. En ese estado, el cerebro integra información, procesa emociones pendientes y genera las ideas más creativas. Cuando rellenas cada segundo con el móvil, le robas ese tiempo al cerebro. La creatividad no viene del estímulo constante. Viene del espacio entre estímulos. Aburríte más. Tu cerebro te lo agradecerá.' },
]
